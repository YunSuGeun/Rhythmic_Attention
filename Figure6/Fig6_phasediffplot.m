...
cd(rawDir)
figDir = 'C:\Users\user\Desktop\Rhythmic_Attention\Figure\Figure6\Phase';
...
for v = 1:2
    ...
    for i = 1:length(indices)
        ...
        [pval, z] = circ_rtest(sig_avg_angle);  
        mu = circ_mean(sig_avg_angle,[],2);
        mu = wrapToPi(mu);
        m2 = polarplot([0,mu], rl, Color = 'cyan',LineWidth= 4, DisplayName='Mean significant');   
